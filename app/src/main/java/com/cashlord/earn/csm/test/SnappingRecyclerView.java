package com.cashlord.earn.csm.test;
/*
...
public class SnappingRecyclerView extends RecyclerView {
    ...
    public void setOrientation(Orientation orientation) {
        ...
        if (_orientation == Orientation.HORIZONTAL) {
            orientationValue = RecyclerView.HORIZONTAL;
        } else {
            orientationValue = RecyclerView.VERTICAL;
        }
        setLayoutManager(new LinearLayoutManager(getContext(), orientationValue, false));
    }
