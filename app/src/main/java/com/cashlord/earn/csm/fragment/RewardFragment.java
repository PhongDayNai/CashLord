...
import static com.cashlord.earn.helper.Constatnt.REWARD;
...
import com.cashlord.earn.csm.adapter.Reward_adapter;
import com.cashlord.earn.csm.model.Reward_model;
...
import com.cashlord.earn.helper.ShimmerExtension;
...
public class RewardFragment extends Fragment {
    ...
    private void parseJsonFeed(JSONObject response) {
        ...
        try {
            ...
            ShimmerExtension.safelyHide(shimmer);
            reward_list.setVisibility(View.VISIBLE);

        } catch (JSONException e) {
            e.printStackTrace();
            ContextExtensions.showLongToast(getContext(), e.getMessage());
            ShimmerExtension.safelyHide(shimmer);
        }
    }
