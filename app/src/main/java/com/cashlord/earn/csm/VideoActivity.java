...
import static com.cashlord.earn.helper.PrefManager.EXTRA_SPIN_COUNT;
import static com.cashlord.earn.helper.PrefManager.SPIN_COUNT;
import static com.cashlord.earn.helper.PrefManager.SPIN_COUNT_PER_DAY;
...
import com.cashlord.earn.RewardedAds;
import com.cashlord.earn.csm.topsheet.ChanceOverDialog;
...
import com.cashlord.earn.luckywheel.LuckyWheelView;
import com.cashlord.earn.luckywheel.model.LuckyItem;
        ...
        extra_spin_btn.setOnClickListener(v-> {
            if (Integer.parseInt(PrefManager.getSavedString(VideoActivity.this, SPIN_COUNT_PER_DAY)) >= getExtraSpinCount()) {
                if (!AdsManager.isRewardedVideoAdLoaded(VideoActivity.this)) {
                    ...
                    RewardedAds.getInstance(VideoActivity.this).loadAd();
                    ...
                    RewardedAds.getInstance(VideoActivity.this).showAd(() -> {
