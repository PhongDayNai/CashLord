package com.cashlord.earn.Adapter;
...
public class Earning_Adapter extends RecyclerView.Adapter<Earning_Adapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDate(String title) { date.setText(title); }

        public void setCoin(String description) { coin.setText(description); }

        public void setDesc(String description) { desc.setText(description); }
    }
}