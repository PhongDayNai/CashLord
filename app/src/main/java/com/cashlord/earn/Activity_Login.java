...
import static com.cashlord.earn.Activity_otp.chkref;
...
import static com.cashlord.earn.helper.Helper.FRAGMENT_FORGOT_PASSWORD;
import static com.cashlord.earn.helper.Helper.FRAGMENT_SIGNUP;
import static com.cashlord.earn.helper.Helper.FRAGMENT_TYPE;
import static com.cashlord.earn.helper.Helper.getTextFromTextView;
import static com.cashlord.earn.helper.Helper.isValidEmail;
import static com.cashlord.earn.helper.Helper.isValidPassword;
...
public class Activity_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ContextExtensions.showShortToast(this, "Welcome to the " + getResources().getString(R.string.app_name));
        ...
        LoginManager.getInstance().registerCallback(callbackManager,
                new FacebookCallback<LoginResult>() {
                    ...
                    public void onCancel() {
                        ContextExtensions.showShortToast(Activity_Login.this, "Login failed!");
                    }

                    @Override
                    public void onError(FacebookException exception) {
                        ContextExtensions.showShortToast(Activity_Login.this, exception.getMessage());
                    }
                });
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (jsonResponse.getString("error").equalsIgnoreCase("false")) {
                                    ...
                                    if (isCustomLogin) {
                                        hidepDialog();
                                        ContextExtensions.showLongToast(Activity_Login.this, "This email is not registered");
                                    } else {
                                ...
                                e.printStackTrace();
                                ContextExtensions.showLongToast(Activity_Login.this, "Check User " + e.toString());
                                hidepDialog();
                            }
                        }
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (check3.isChecked()) {
                    ...
                    ContextExtensions.showShortToast(Activity_Login.this, "You are not Eligible");
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            ContextExtensions.showLongToast(Activity_Login.this, "signInWithCredential:failure" + task.getException());
                        }
                    }
                });
    }
                                ...
                                if (AppController.getInstance().getState().equals(ACCOUNT_STATE_ENABLED)) {
                                    ...
                                    try {
                                        ...
                                        if (response.getString("error").equalsIgnoreCase("true")) {
                                            ContextExtensions.showShortToast(getApplicationContext(),response.getString("message"));
                                    ...
                                    ContextExtensions.showShortToast(getApplicationContext(), getText(R.string.msg_account_blocked).toString());
                                }

                            } else {
                                ContextExtensions.showShortToast(getApplicationContext(), "Invalid login details try again");
                            }
