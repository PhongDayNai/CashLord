...
import static com.cashlord.earn.helper.Constatnt.FCM_ID;
import static com.cashlord.earn.helper.Constatnt.POINTS;
import static com.cashlord.earn.helper.Constatnt.SPIN_TYPE;
import static com.cashlord.earn.helper.Constatnt.UPDATE_FCM;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("error").equalsIgnoreCase("false")) {
                                ...
                                ContextExtensions.showShortToast(context,  response.getString("message"));
                            }
                        } catch (Exception e) {
