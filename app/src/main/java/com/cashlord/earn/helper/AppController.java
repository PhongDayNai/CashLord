...
public class AppController extends Application {
    ...
    public String username, fullname, accessToken, email, ip_addr, points, phone, password, refercodee, badge, image, rank;
